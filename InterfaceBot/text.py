start = "Добро пожаловать, я робот компании Timeweb! Могу помочь Вам решить многие вопросы." \
        ...
        + "\n" + \
        "Перенести домен - помогу с переносом" \
        + "\n" + \
        "Изменить администратора - подскажу как можно изменить данные владельца домена" \
        + "\n" + \
        "Владелец аккаунта - скажу как изменить реквизиты владельца аккаунта"  \
        + "\n" + \
        "Восстановить аккаунт - помогу восстановить доступ к Вашему аккаунту" \
        + "\n" + \
        "Помощь - инструкция, как можно управлять мной"
...
pay = "Оплатить услуги возможно с помощью раздела панели управления аккаунтом \"Финансы и оплата\", " \
      "либо с помощью раздела \"Оплата\" на нашем сайте: http://timeweb.com/ru/#pay, выбрав подходящий способ оплаты." \
      + "\n\n" + \
      "На нашем сайте Вы также сможете ознакомиться с видеоинструкцией по вопросу оплаты услуг " \
      "http://timeweb.com/ru/help/pages/viewpage.action?pageId=4982785."


difference = "Технический перенос домена необходим, когда осуществляется перенос сайта " \
             "от одного хостинг-провайдера к другому" \
            + "\n\n" + \
            "После административного переноса домена на наш договор появится возможность продлевать домен(ы) через " \
            "панель управления аккаунтом."


transfer = "Технический или административный перенос? (чтобы узнать в чем отличие нажмите /difference)" \
           + "\n" + \
...
tehno = "Выполнить технический перенос доменного имени " \
        ...
        "сообщение на почту info@timeweb.ru либо из Панели управления аккаунтом по ссылке " \
        "https://hosting.timeweb.ru/tickets" \
...
were_password = "Для восстановления доступа в панель управления аккаунтом выполните следующие действия:" \
                + "\n\n" + \
                "1. Зайдите на страницу авторизации https://hosting.timeweb.ru/login." \
                + "\n" + \
